...
func TestResumeGraphQLDataApi(t *testing.T) {
...
func TestResumeGraphQLDataApiWithTrailingNewline(t *testing.T) {
	helper := testutils.NewAuraTestHelper(t)
	defer helper.Close()
	...
	helper.ExecuteCommand(fmt.Sprintf("data-api graphql resume --format json --instance-id %s %s\"\n\" --rw", instanceId, dataApiId))
