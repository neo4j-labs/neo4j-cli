...
If you're unsure of possible configurations, run 'neo4j-cli aura api v1/tenants/<project-id>' to discover the full list of supported configurations for your project. The output's instance_configurations array lists every valid combination of --cloud-provider, --region, --type, and --memory.
