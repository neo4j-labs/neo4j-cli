...
func TestGetSnapshot(t *testing.T) {
	...
	helper.ExecuteCommand(fmt.Sprintf("instance snapshot get --format json --instance-id %s %s", instanceId, snapshotId))
...
func TestGetSnapshotWithTrailingNewline(t *testing.T) {
	...
	helper.ExecuteCommand(fmt.Sprintf("instance snapshot get --format json --instance-id %s %s\"\n\"", instanceId, snapshotId))
