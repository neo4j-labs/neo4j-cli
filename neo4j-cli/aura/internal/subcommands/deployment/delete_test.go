...
func TestDeleteDeploymentConfirmGate_NonTTYWithoutFlags_Exit2(t *testing.T) {
...
func TestDeleteDeploymentConfirmGate_NonTTYWithBothFlags_Proceeds(t *testing.T) {
	confirm.SetStdinIsTerminalForTest(t, func() bool { return false })
...
func TestDeleteDeploymentConfirmGate_TTYAnswerY_Proceeds(t *testing.T) {
	...
	mockHandler.AssertCalledTimes(1)
	mockHandler.AssertCalledWithMethod(http.MethodDelete)
	helper.AssertErrContainsStrings([]string{"Delete deployment"})
}

func TestDeleteDeploymentConfirmGate_TTYAnswerN_Cancels(t *testing.T) {
	confirm.SetStdinIsTerminalForTest(t, func() bool { return true })
