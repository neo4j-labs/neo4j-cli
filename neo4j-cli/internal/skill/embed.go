...
// Package skill embeds the generated neo4j-cli agent-skill bundle so the
// `neo4j-cli skill install` command can write it onto the host filesystem.
//
// Regenerate the bundle with `go generate ./neo4j-cli/internal/skill/...`
...
// the cobra tree built by app.NewCmd.
package skill
