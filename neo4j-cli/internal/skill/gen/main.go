...
//
// It builds the neo4j-cli cobra tree via app.NewCmd, walks it with
// common/skill/render.Bundle, and writes SKILL.md + references/<sub>.md
...
//   - `go run ./neo4j-cli/internal/skill/gen` (direct invocation).
//
...
// parent package (neo4j-cli/internal/skill). Resolved via runtime.Caller
...
func packageDir() (string, error) {
	...
	// thisFile = .../neo4j-cli/internal/skill/gen/main.go
