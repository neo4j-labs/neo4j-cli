...
| `--no-print-password` | bool | false | Omit the generated password from stdout output. The stored credential still connects via --credential <name> (the password is not CLI-readable). |
